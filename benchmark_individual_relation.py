...
def main():
    ...
    # Output
    parser.add_argument("--output_dir", type=str, default="results/hug_trained_improved/")
    ...
    # Load prompts JSON
    with open("Benchmark/prompts_hug.json", "r") as f:
    ...
    # LoRA
    lora_weights = "lora-weights/lora-trained-xl-hugging-improved"
    if args.load_lora:
    ...
    for entry in prompt_entries:
        ...
        sub_output_dir = os.path.join(args.output_dir, sub1)
